...
if st.button("Predict"):
    file_ = open(r"C:\Users\jjric\Documents\6m-rain.gif", "rb")
    contents = file_.read()
    data_url = base64.b64encode(contents).decode("utf-8")
    file_.close()

    file = open(r"C:\Users\jjric\Documents\green-cola-no.gif", "rb")
    contents = file.read()
    data_url_no = base64.b64encode(contents).decode("utf-8")
    file.close()
    
loaded_model = pickle.load(open(r"C:\Users\jjric\Documents\RF.sav", 'rb'))
